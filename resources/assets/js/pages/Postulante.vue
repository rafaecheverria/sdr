               ...
               <el-table-column prop="email" minWidth= 220 label="Email"></el-table-column>
                <el-table-column :min-width="120" fixed="right" label="Actions">
                  <template slot-scope="props">
                    <a v-tooltip.top-center="'Postulaciones'" class="btn-info btn-simple btn-link"
                      @click="openModal('usuario', 'postulaciones', props.row)">
  ...
  export default{
    ...
    methods: {
      listarUsuarios(page, buscar, criterio){
        let me=this;
        var url = 'usuarios?page='+ page + '&buscar='+ buscar + '&criterio='+ criterio + '&tipo='+ 'Postulante';
