        ...
        <div class="col-sm-12">
          <div class="table-responsive">
            <el-table stripe style="width: 100%;" :data="tableData">
              <el-table-column prop="nombres" minWidth= 150 label="Nombres"></el-table-column>
               <el-table-column prop="apellidos" minWidth= 150 label="Apellidos"></el-table-column>
               <el-table-column prop="email" minWidth= 180 label="Email"></el-table-column>
               <el-table-column prop="anexo" minWidth= 100 label="Anexo"></el-table-column>
                <el-table-column :min-width="120" fixed="right" label="Actions">
                  <template slot-scope="props">
                    <a v-tooltip.top-center="'Editar'" class="btn-info btn-simple btn-link"
    ...
    <div class="col-md-12">
      <el-dialog
        ...
        <span slot="footer" class="dialog-footer">
          ...
          <button class="btn btn-info" v-if="tipoAccion == 3" @click="AgregarRoles()">Agregar Roles</button>
        </span>
      </el-dialog>
     </div>
  ...
  export default{
    ...
    methods: {
      listarUsuarios(page, buscar, criterio){
        let me=this;
        var url = 'usuarios?page='+ page + '&buscar='+ buscar + '&criterio='+ criterio + '&tipo='+ '';
        ...
        switch(modelo){
          case 'usuario': 
            switch(accion){
              ...
              case 'roles': 
                this.arrayRoles = []
                this. cargarRolesSelect(data['id'])
                this.errores= [],
                this.modal = true;
                this.tituloModal  = 'Roles de Usuario';
                this.tipoAccion   = 3;
